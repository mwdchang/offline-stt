...
// }
    ...
    const parseBethune = (bethuneNode: any, currentNode: ElkNode, path: string) => {
      ...
      bethuneNode.nodes.forEach((n: any) => {
        ...
        // Recurse
        const nextBethuneObj = yaml2json(composites[n.composition]!);
